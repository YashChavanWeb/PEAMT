    ...
    return (
        <div className='p-3 max-w-lg max-auto'>
            ...
            ' onClick={() => fileRef.current.click()} />
                ...
                <input defaultValue={currentUser.username} type="text" name="" id="username" placeholder='Username' className='bg-slate-100 rounded-lg p-3' />

                <input defaultValue={currentUser.email} type="text" name="" id="email" placeholder='Email' className='bg-slate-100 rounded-lg p-3' />


                <input type="password" name="" id="password" placeholder='Password' className='bg-slate-100 rounded-lg p-3' />
